...
dashboardPage(skin = "blue",
  ...
  dashboardSidebar(sidebarMenu(
    ...
    menuItem("Visualization", tabName = "visualization", icon = icon("camera"), startExpanded = FALSE,
    ...
    menuItem("Statistics", tabName = "statistics", icon = icon("sliders"), startExpanded = FALSE,
      ...
      menuSubItem("Automatic Statistical Analysis", tabName = "asa", icon = icon("star"))),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem("asa",
              source("ui-tab-asa.R",local=TRUE)$value),
      tabItem("help",
