...
POMAShiny allows to combine features applying a summarization function to sets of features as defined by a "Grouping File". This feature is powered by the `MSnbase` R/Bioconductor package
