...
Here, features 1 and 2, and features 5 and 6 will be combined while features 3 and 4 will remain intact, according to the grouping factor (second column). The combination result is shown below:
